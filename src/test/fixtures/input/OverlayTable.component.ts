 ...
 import { MgFormControlsAccessor, MgControlName, MgCustomProperties } from "./OverlayTable.mg.controls.g"; 
 ...
 export class OverlayTable extends BaseMatTableMagicComponent implements MagicModalInterface { 
